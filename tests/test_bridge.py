...
class TestCostFunctions:
    ...
    def test_track_cost_adds_entry(self):
        bridge.track_cost("s1", "gpt-4o-mini", 1000, 500)
        assert "s1" in bridge._session_costs
        assert "gpt-4o-mini" in bridge._session_costs["s1"]
        assert bridge._session_costs["s1"]["gpt-4o-mini"] > 0
    ...
    def test_get_session_cost_sums_all_models(self):
        bridge.track_cost("s1", "gpt-4o-mini", 1_000_000, 500_000)
